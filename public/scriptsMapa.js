...
///////////////// MOSTRAR /////////////////////    
    function mostrarDatos(){
        $.ajax({
            url:'https://usuariosloginonline.herokuapp.com/api/mapa',
            type:'GET',
...
/// BUSCAR ///
    $('#busqueda').submit(function(e){
        ...
        $.ajax({
            url:'https://usuariosloginonline.herokuapp.com/api/mapa/'+buscar,
            type:'GET',
            success: function (respuesta){
                //console.log(respuesta);
                let datos=respuesta;
...
//////////GUARDAR Y MODIFICAR/////////////////////
    $('#enviarDatos').submit(function(e){        
        ...
        if (tipo=='guardar') {  
            $.post('https://usuariosloginonline.herokuapp.com/api/mapa',DATOS, function (respuesta){
